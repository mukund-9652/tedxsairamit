  ...
  return {
    ...
    initSlider: function () {
      ...
      t.each(function (e) {
        ...
        s.attr("data-dsn-id", e),
          0 === e && s.addClass("dsn-active dsn-active-cat"),
          n.append(s);
        ...
        i.isDemoSlide() ||
          ...
          dsnGrid.convertTextLine(a, a),
          (t = s = a = null);
      }),
        i.isDemoSlide() ||
          (o.push(o.shift()), $(".box-next > .swiper-wrapper").append(o)),
        (o = i = n = t = null);
    },
      ...
      return new Swiper(".main-slider .slide-inner", {
        ...
        on: {
          ...
          imagesReady: function () {
            let e = $(this.slides[this.activeIndex]).find(
      ...
      e.on("progress", function () {
        ...
        for (let n = 0; n < e.slides.length; n++) {
          let i = e.slides[n].progress,
            ...
            s = i * o,
            a = t ? "Y" : "X";
          (e.slides[n].querySelector(".image-bg").style.transform =
            "translate" + a + "(" + s + "px) skew" + a + "(" + s / 50 + "deg)"),
            (s = a = o = i = null);
        }
        e = null;
      });
    ...
    slideChange: function (t) {
      ...
      t.on("slideChange", function () {
        ...
        let r = $(this.slides[this.activeIndex]).find(
          '[data-dsn="video"] video'
        );
        ...
        let c = e.find('.dsn-slider-content [data-dsn-id="' + l + '"]'),
          ...
          f = s > l;
        n.progress(1),
          (n = new TimelineLite()).staggerFromTo(
            d,
            0.3,
            i.showText().title,
            i.hideText(f).title,
            ...
            function () {
              e
                ...
                c.addClass("dsn-active"),
                c.addClass("dsn-active-cat");
            }
          ),
          n.staggerFromTo(
            dsnGrid.randomObjectArray(u, 0.8),
            0.8,
            i.hideText(!f).title,
            i.showText().title,
            0.05,
    ...
    showText: function () {
      return {
        ...
        subtitle: { autoAlpha: 1, y: "0%", ease: Elastic.easeOut },
      };
    },
    hideText: function (e) {
      return {
    ...
    run: function () {
      ...
      if (
        (this.isDemoSlide() ||
          (this.progress(o, !i), this.touchStart(o), this.setTransition(o)),
        this.slideChange(o),
        this.isDemoSlide() && !e.hasClass("has-loop") && o.slideTo(1),
        t.length <= 0 || this.isDemoSlide())
      )
        return void (o = null);
      ...
      (o.controller.control = s),
        ...
        t.on("click", function () {
          n.isActive() ||
            (s.slides.length === s.activeIndex + 1
              ? o.slideTo(0)
              : o.slideNext());
        }),
        (t = null);
...
function toggleButton() {
  $(".image-head-contact").each(function () {
    ...
    e.to($(this).find(".box-overlay"), 0.5, { autoAlpha: 0 }),
      e.staggerTo(
        $(this).find(".contact-info-item"),
        0.8,
        { y: 20, autoAlpha: 0, ease: Back.easeInOut.config(4) },
        0.3,
        0
      ),
...
!(function (e) {
  ...
  function t(t) {
    e("[data-dsn-bg]").each(function () {
      ...
      t && e(this).css("background-color", t),
        t && (e(this).css("color", n), e(this).addClass("section-dsn-color")),
        (t = null);
    }),
      d.start(),
      c.allInt(),
      ...
      e(".gallery-portfolio").each(function () {
        let t = e(this);
        t.justifiedGallery({ rowHeight: 400, margins: 15 });
      ...
      setTimeout(function () {
        e('a[href="#"]').on("click", function (e) {
          ...
          window.location.hash.length &&
            (l.scrollTop(0), dsnGrid.scrollTop(window.location.hash, 1, -100)),
          c.dsnScrollTop(),
          t
            ? f &&
              (f.t1.kill(),
    ...
    t && i.off("click"),
      ...
      o.find("button").on("click", function () {
        e(this).siblings().removeClass("active"),
          ...
          e(".projects-list").isotope({ filter: e(this).attr("data-filter") });
      }),
  ...
  function i() {
    ...
    return {
      ...
      ajaxNormal: function () {
        ...
        r.append(t),
          a.to(t, 0.5, { scaleY: 1, ease: Circ.easeIn }, 0),
          (t = null);
      },
      ajaxSlider: function (t) {
        let n = t.parents(".slide-content"),
          i = n.data("dsn-id"),
          o = e(
            '.main-slider .slide-item[data-dsn-id="' + i + '"] .cover-bg'
          ).first(),
          s = n.find(".title");
        o.removeClass("hidden"),
          this.dsnCreateElement(o, e(".bg-container"), s, s.find("a"));
      },
      ...
      ajaxWork: function (e) {
        ...
        o.addClass("fw-600"),
          ...
          a.to(n.find("img"), 1, { height: "100%", top: "0%", y: "0" }),
          (t = i = o = null);
      },
      ...
      dsnCreateElement: function (t, o, s, l) {
        ...
        d.css("background-color", r.css("background-color")),
          ...
          (i = this.addElement(d, s, l)).hasClass("dsn-cutter") &&
        ...
        if (
          ...
          i.length &&
            ...
            a.to(
              i,
              0.8,
              { css: { className: "+=" + l.attr("class") } },
              "-=0.8"
            ),
            l.parents(".v-middle-horizontal").length
              ? i.css("width", "max-content")
              : i.css("width", l.width()),
          ...
          e && (e = e.split(",")[5]),
            e &&
              a.staggerTo(
                dsnGrid.randomObjectArray(i.find(".dsn-chars-wrapper"), 0.5),
                0.6,
                { force3D: !0, y: e, ease: Back.easeOut.config(1.7) },
                0.04,
                "-=0.8"
              );
        }
  ...
  function o() {
    ...
    return (
      a.to(".header-top .header-container, .site-header ", 0.5, {
        backgroundColor: "#000",
        paddingTop: 15,
        paddingBottom: 15,
      }),
      a.reverse(),
      r.to(
        ".header-top .header-container,  .site-header , .dsn-multi-lang",
        0.5,
        { top: -70 }
      ),
      r.reverse(),
      d.getListener(function (e) {
        ...
        void 0 !== n && (i = n.top - 100),
          t > i ? (a.play(), s < t ? r.play() : r.reverse()) : a.reverse(),
          (s = t);
      }),
      { t1: a, t2: r }
    );
  ...
  function a(t) {
    function n() {
      dsnGrid.elementHover(
        ...
        dsnGrid.elementHover(
          i,
          ".proj-slider-image > .slick-list ,.our-work .slick-slider > .slick-list, .slider-project-swiper .swiper-wrapper ",
          "cursor-scale-half cursor-drag cursor-next cursor-prev"
        ),
        dsnGrid.elementHover(
          i,
          ".main-slider:not(.has-horizontal) .slide-item",
          "cursor-scale-half cursor-up-down cursor-drag cursor-next cursor-prev"
        ),
        dsnGrid.elementHover(
          i,
          ".main-slider.has-horizontal .slide-item",
          "cursor-scale-half cursor-drag cursor-next cursor-prev"
        ),
        dsnGrid.elementHover(
          i,
          '[data-cursor="next"]',
          "cursor-scale-half cursor-next"
        ),
        dsnGrid.elementHover(
          i,
          '[data-cursor="prev"]',
          "cursor-scale-half cursor-prev"
        ),
    ...
    return dsnGrid.isMobile() || !r.hasClass("dsn-cursor-effect")
      ? (i.length &&
          (i.css("display", "none"), r.removeClass("dsn-cursor-effect")),
        void (i = null))
      : !0 === t
  ...
  !(function () {
    let t = e(".preloader"),
      ...
      r = dsnGrid.pageLoad(0, 100, 1e3, function (e) {
        n.text(e),
          (o.value = e),
          i.css("clip-path", "inset(" + (100 - e) + "% 0% 0% 0%)"),
          a.css("width", e + "%");
      });
    l.on("load", function () {
      clearInterval(r),
      ...
      return {
        ...
        start: function () {
          r.removeClass("locked-scroll"),
            ...
            this.isScroller(!0) && t.init(n, { damping: 0.05 });
        },
      };
    })(),
    c = (function () {
      ...
      return {
        ...
        headerPages: function () {
          ...
          o.length > 0 && l.to(o, 1, { y: "30%", scale: 1 }, 0),
            s.length > 0 &&
              l.to(
                ...
                0.8,
                {
                  ...
                  y: "100%",
                  autoAlpha: 0,
                  scale: o.hasClass("header-scale-hero")
                    ? 0.9
                    : o.hasClass("header-no-scale-hero")
                    ? 1
                    : 1.08,
                },
                0
            ...
            a.length > 0 &&
              l.to(a, 0.8, { force3D: !0, y: 60, autoAlpha: 0 }, 0);
          let r = dsnGrid
              .tweenMaxParallax(d, t)
              .addParrlax({ id: i, triggerHook: 0, tween: l }),
            c = o.find("video");
          c.length
            ? (r.on("enter", function () {
                ...
                .on("click", function (t) {
                  t.stopPropagation(),
                    e(this).hasClass("sound-no-mute")
                      ? ((c.get(0).muted = !0),
                        TweenMax.to(e(this).find("svg"), 0.8, { x: 4 }),
                        TweenMax.staggerTo(
                          e(this).find(".wave-line"),
                          0.8,
                          { autoAlpha: 0 },
                          0.2
                        ))
                      : ((c.get(0).muted = !1),
                        TweenMax.to(e(this).find("svg"), 0.8, { x: 0 }),
                        TweenMax.staggerTo(
                          e(this).find(".wave-line"),
                          0.8,
                          { autoAlpha: 1 },
        ...
        headerProject: function () {
          ...
          o.length > 0 &&
            ...
            s.length &&
              ...
              u.to(
                s.find(".metas"),
                1,
                { force3D: !0, y: "0", ease: Back.easeOut.config(1.7) },
                0
              ),
              u.staggerTo(
          ...
          c.length &&
            f.on("progress", function (t) {
              TweenLite.to(
                e('[data-dsn-header="project"]').find(".scroll-d img"),
                0.3,
                { rotation: 500 * t.progress }
              );
            }),
            f && n.push(f),
        ...
        nextProject: function () {
          ...
          o.length &&
            ...
            TweenLite.set(o.find(".dsn-chars-wrapper"), {
              y: 50,
              autoAlpha: 0,
            }),
            a.staggerTo(
              dsnGrid.randomObjectArray(o.find(".dsn-chars-wrapper"), 0.8),
              1,
              {
                force3D: !0,
                y: "0",
                ...
                o.length &&
                  n.staggerFromTo(
                    ...
                    { y: 20, opacity: 0 },
                    {
                      y: 0,
                      opacity: 1,
                      delay: i.hasClass("dsn-animate") ? 0.5 : 0,
                      ease: Back.easeOut.config(1.7),
                    },
                    0.2,
                    0
        ...
        animateNumbers: function () {
          ...
          t.each(function () {
            ...
            t.each(function (t) {
              ...
              (n._totalDuration = 1),
              dsnGrid
                .tweenMaxParallax(d, new ScrollMagic.Controller())
                .addParrlax({
                  id: this,
                  reverse: !1,
                  triggerHook: 0.5,
            ...
            let r = dsnGrid
              ...
              .addParrlax({
                ...
                tween: TweenLite.to(o, 0.5, {
                  force3D: !0,
                  x: -1 * (s.last().offset().left - 1.5 * s.last().width()),
            ...
            if (l.length > 0) {
              ...
              let e,
                s = dsnGrid.getData(
                  l,
                  "y",
                  l.hasClass("has-opposite-direction") ? "-20%" : "30%"
                ),
                f = { y: s, skewX: 0, ease: i, scale: 1 };
              l.hasClass("has-top-bottom")
                ? (e = TweenMax.to(l, o, f))
                : ((f.scale = dsnGrid.getData(l, "scale", 1.1)),
                  (e = TweenMax.to(l, o, f))),
                l.css("perspective", a.width() > 1e3 ? 1e3 : a.width());
              let h = dsnGrid
                .tweenMaxParallax(d, t)
                .addParrlax({
                  id: this,
        ...
        moveSection: function () {
          ...
          i.each(function () {
            let i = e(this);
            if (
              (i.removeAttr("data-dsn-grid"),
              i.addClass("dsn-move-section"),
              "tablet" === i.data("dsn-responsive") && l.width() < 992)
            )
              return;
            let a = dsnGrid.getData(i, "move", -100),
              ...
              f = dsnGrid
                ...
                .addParrlax({
                  ...
                  triggerHook: r,
                  duration: u,
                  tween: TweenMax.to(i, s, { y: a, autoAlpha: c, ease: o }),
                });
        ...
        changeColor: function () {
          e('[data-dsn="color"]').each(function () {
            let i = dsnGrid.getData(
                this,
                "duration",
                e(this).outerHeight() + 50
              ),
        ...
        bySwiper: function (n, i) {
          dsnGrid.convertToJQuery(n).each(function () {
            let n = new Swiper(e(this).find(".swiper-container"), {
              ...
              speed: 1e3,
              navigation: {
                nextEl: e(this).find('[data-cursor="next"]'),
                prevEl: e(this).find('[data-cursor="prev"]'),
              },
            ...
            (i = e.extend(
              !0,
              {
                ...
                responsive: [
                  {
                    breakpoint: 992,
                    settings: { dots: !e(this).hasClass("dsn-not-dot") },
                  },
                ],
              },
              i || {}
          ...
          this.destory(),
            ...
            this.bySlick(".testimonials-nav", {
              ...
              responsive: [
                {
                  breakpoint: 768,
                  settings: { vertical: !1, centerMode: !1, dots: !1 },
                },
                {
                  breakpoint: 576,
                  settings: { slidesToShow: 2, vertical: !1, centerMode: !1 },
                },
                {
                  breakpoint: 400,
                  settings: { slidesToShow: 2, vertical: !0, centerMode: !1 },
                },
              ],
            }),
          ...
          t.find("ul.extend-container > li").off("mouseenter"),
            t.find("ul.extend-container > li").on("mouseenter", function () {
              ...
              let t = e(this),
                i = t.find(" > ul");
              i.length
                ? n.setLine(i.offset().left, 65, i.width(), t.offset().left)
                : n.setLine(e(this).offset().left),
                (t = null),
                (i = null);
            }),
        ...
        hamburgerOpen: function () {
          ...
          o.set(n.find(".icon-center"), { display: "none" }),
            ...
            o.to(
              n.find(".icon-bottom"),
              0.5,
              { width: 23, rotation: -45, top: -5, ease: a },
              0
            ),
                ...
                t.stopPropagation(),
                  s._totalDuration > 0 ||
                    ...
                    s.staggerFromTo(
                      ...
                      0.5,
                      { x: 50, autoAlpha: 0 },
                      { x: 0, autoAlpha: 1, ease: Back.easeOut.config(1.7) },
                      0.1
                    ));
              }),
            n.off("click"),
